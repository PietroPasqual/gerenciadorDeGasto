...
export const TOPICOS: TopicoAjuda[] = [
  ...
  },
  {
    ...
    sinonimos: ['ano', 'grafico', 'evolução', 'tendencia'],
    corpo: [
      ...
      'Meses futuros aparecem como "previsto": eles já contam os gastos fixos que se repetem, porque esses são os únicos que dá para saber com antecedência.',
  ...
  },
  {
    ...
    sinonimos: ['juntar', 'guardar', 'objetivo', 'prazo', 'sonho'],
    corpo: [
      ...
      'A projeção só aparece quando há histórico suficiente para ela significar alguma coisa. Sem base, o app não chuta.',
  ...
  },
  {
    ...
    para: '/configuracoes',
    resumo: 'Perfil, aparência, lembretes, categorias, cartões, metas, dados.',
    sinonimos: ['tema', 'escuro', 'limite', 'orçamento', 'apagar tudo'],
    corpo: [
      'Categorias: nome, cor e limite mensal (opcional). A barra da categoria fica amarela a partir de 80% do limite e vermelha quando estoura.',
      ...
      'Dados: baixar backup, restaurar de um arquivo, e apagar tudo.',
    ],
  },
